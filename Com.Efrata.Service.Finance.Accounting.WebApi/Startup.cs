...
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.DPPVATBankExpenditureNote;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.GarmentPurchasingExpedition;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.GarmentPurchasingExpedition.Reports;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.CashierApproval;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.ClearaceVB;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.CreditBalance;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.CreditorAccount;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.DailyBankTransaction;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.GarmentInvoicePayment;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.JournalTransaction;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.LockTransaction;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.Master;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.PaymentDispositionNote;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.PaymentDispositionNotVerifiedReport;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.PurchasingDispositionExpedition;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.SalesReceipt;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.VBExpeditionRealizationReport;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.VBRealizationDocumentNonPO;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.VBRequestAll;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.VBStatusReport;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Services.CashierApproval;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Services.ClearaceVB;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Services.CreditBalance;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Services.CreditorAccount;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Services.DailyBankTransaction;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Services.DownPayment;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Services.GarmentInvoicePayment;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Services.JournalTransaction;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Services.LockTransaction;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Services.Master;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Services.Memo;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Services.PaymentDispositionNote;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Services.PaymentDispositionNotVerifiedReport;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Services.PurchasingDispositionExpedition;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Services.RealizationVBNonPO;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Services.SalesReceipt;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Services.VBExpeditionRealizationReport;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Services.VbNonPORequest;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Services.VBRealizationDocumentNonPO;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Services.VBRequestAll;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Services.VBStatusReport;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Services.VBVerification;
...
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.VbWIthPORequest;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.GarmentPurchasingPphBankExpenditureNote;
using Com.Efrata.Service.Finance.Accounting.Lib.Services.CacheService;
...
using Com.Efrata.Service.Finance.Accounting.Lib.Services.OthersExpenditureProofDocument;
...
using System.Linq;
using System.Text;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.GarmentDebtBalance;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.GarmentDispositionExpedition;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.GarmentInvoicePurchasingDisposition;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.GarmentDispositionPaymentReport;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Services.AccountingBook;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.MemoGarmentPurchasing;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Services.MemoGarmentPurchasing;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Services.MemoDetailGarmentPurchasing;
using Microsoft.ApplicationInsights.AspNetCore;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.MemoGarmentPurchasingReport;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Services.MemoGarmentPurchasingReport;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.GarmentDownPaymentReport;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.GarmentFinance.BankCashReceipt;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Services.GarmentFinance.BankCashReceipt;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.PurchasingMemoDetailTextile;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Reports.ExportSalesDebtorReport;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Reports;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.GarmentFinance.BankCashReceiptDetail;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Services.GarmentFinance.BankCashReceiptDetail;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.PurchasingMemoTextile;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.GarmentFinance.Memorial;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.GarmentFinance.MemorialDetail;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.GarmentFinance.BankCashReceiptDetailLocal;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Services.GarmentFinance.BankCashReceiptDetailLocal;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.GarmentFinance.MemorialDetailLocal;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Services.GarmentFinance.MemorialDetailLocal;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.GarmentFinance.Reports.DebtorCard;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.GarmentFinance.Reports.BankCashReceiptMonthlyRecap;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.GarmentFinance.Reports.ExportSalesOutstanding;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.GarmentFinance.Reports.LocalSalesOutstanding;
using Com.Efrata.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.Reports.LocalSalesDebtorReport;
