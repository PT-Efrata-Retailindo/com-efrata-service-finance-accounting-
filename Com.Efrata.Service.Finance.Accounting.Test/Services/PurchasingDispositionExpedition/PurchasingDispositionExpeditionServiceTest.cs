...
using Com.Efrata.Service.Finance.Accounting.Lib.ViewModels.PurchasingDispositionAcceptance;
using Com.Efrata.Service.Finance.Accounting.Lib.ViewModels.PurchasingDispositionExpedition;
using Com.Efrata.Service.Finance.Accounting.Lib.ViewModels.PurchasingDispositionReport;
using Com.Efrata.Service.Finance.Accounting.Lib.ViewModels.PurchasingDispositionVerification;
using Com.Efrata.Service.Finance.Accounting.Test.DataUtils.NewIntegrationDataUtils;
using Com.Efrata.Service.Finance.Accounting.Test.DataUtils.PurchasingDispositionExpedition;
...
namespace Com.Efrata.Service.Finance.Accounting.Test.Services.PurchasingDispositionExpedition
{
